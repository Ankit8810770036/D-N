...
import {
    ...
    Settings, ShieldAlert, TrendingUp, MessageSquare
} from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="card">
                    ...
                    <div className="space-y-3">
                        ...
                        <Link
                            to="/admin/feedbacks"
                            className="flex items-center gap-4 p-4 bg-gray-50 dark:bg-white/5 rounded-2xl border border-gray-100 dark:border-white/10 hover:border-sky-300/40 hover:bg-sky-50 dark:hover:bg-white/10 transition-all group"
                        >
                            ...
                            <div>
                                <p className="font-bold text-gray-800 dark:text-white text-sm">User Feedback &amp; Triage</p>
                                <p className="text-xs text-gray-400">Review bug reports, ratings &amp; suggestions</p>
                            </div>
                        </Link>
                    </div>
                </div>
